...
class Sage2Spider(scrapy.Spider):
    name = 'SAGE2'
    start_urls = ['http://journals.sagepub.com/toc/bjm/current']
    ...
    def parse(self, response):
        ...
        volume = response.xpath(
            "//div[@class='pager issueBookNavPager']/span[@class='journalNavCenterTd']/div[@class='journalNavTitle']/text()").extract()[0]
